 ...
 */
function wpdocs_codex_teacher_new_init() {
  $labels = array(
  ...
  $args = array(
      ...
      'taxonomies'         => array('teacher-category'),
      'show_ui'            => true,
      'show_in_menu'       => true,
      'query_var'          => true,
...
add_action( 'init', 'wpdocs_codex_teacher_new_init' );


function teacher_category_taxonomy() {
  ...
  register_taxonomy('teacher-category',array('teachers'), array(
    'hierarchical' => true,
    'labels' => $labels,
    'show_ui' => true,
    'show_in_rest' => true,
...
add_action( 'init', 'teacher_category_taxonomy', 0 );