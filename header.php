...
<body <?php body_class(); ?>>
  ...
  <header>
    <div class="top_addressbar">
      <div class="container-fluid">
        <div class="addressbar_wrap">
          <div class="working_time">working Hours: <span><?php the_field('office_timings', 'options'); ?></span>
          </div>
          <nav>
            <?php
            if (have_rows('social_media_links', 'options')) :
              while (have_rows('social_media_links', 'options')) : the_row();
                ...
                $instagram = get_sub_field('instagram_liink');
            ...
            ?>
              ...
              <?php endwhile; ?>
            <?php endif; ?>
            <div class="contact_info_details">Call for consultation: <span><?php the_field('consutation_number', 'options') ;?></span>
            </div>
          </nav>
        </div>
      </div>
    ...
    <div class="bottom_header_tab">
      <div class="container-fluid">
        <div class="header_wrapper">
          <a href="/brahmas" class="brand_logo">
            <?php
            $siteLogo = get_field('site_logo', 'options')
            ?>
            <img src="<?php echo esc_url($siteLogo['url']); ?>" alt="brahmas site hrms">
          </a>
          <nav>
            <?php
            wp_nav_menu(array(
